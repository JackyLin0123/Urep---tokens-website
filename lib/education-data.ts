...
export const QUIZ_REWARDS = {
  PERFECT: { minPercent: 100, tokens: 25, label: "Perfect Score!" },
  GREAT: { minPercent: 80, tokens: 20, label: "Great Job!" },
  GOOD: { minPercent: 60, tokens: 10, label: "Good Effort!" },
...
export const VIDEOS: VideoItem[] = [
  {
    id: "vid-recycling-explained",
    title: "How Recycling Works — The Complete Process",
    description: "Follow the journey of your recyclables from the bin to becoming new products.",
  ...
  {
    id: "vid-ocean-plastic",
    title: "The Ocean Plastic Crisis",
    description: "Explore how plastic waste affects marine ecosystems and what we can do about it.",
  ...
  {
    id: "vid-climate-101",
    title: "Climate Change 101 with National Geographic",
    description: "An accessible introduction to climate science, causes, and impacts.",
  ...
  {
    id: "vid-zero-waste",
    title: "Beginner's Guide to Zero Waste Living",
    description: "Practical tips to dramatically reduce your household waste output.",
    youtubeId: "pqmPBKwBKSQ",
    duration: "8:45",
    category: "Lifestyle",
    emoji: "🌱",
  },
  {
    ...
    description: "Learn how to turn food scraps into nutrient-rich soil for your garden.",
  ...
  },
  {
    ...
    description: "How the clothing industry impacts the environment and what sustainable alternatives exist.",
  ...
  {
    id: "vid-renewable-energy",
    title: "Renewable Energy Explained in 5 Minutes",
    description: "Solar, wind, hydro, and more — understand the future of clean energy.",
  ...
  {
    id: "vid-circular-economy",
    title: "What is a Circular Economy?",
    description: "How rethinking our economic model can eliminate waste and keep resources in use.",
