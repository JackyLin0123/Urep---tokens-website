        ...
        <div className="eco-card p-8">
          ...
          {sent ? (
            ...
            <>
              ...
              <button onClick={handleGoogleLogin} className="w-full btn-secondary mb-4 py-3">
              ...
              <div className="flex items-center gap-3 my-5">
                ...
                <span className="text-xs text-surface-400 uppercase tracking-wider">or use email</span>
                <div className="flex-1 h-px bg-surface-200" />
              </div>
